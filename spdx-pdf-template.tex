...
% listing colors
%
\definecolor{listing-background}{HTML}{f7f3e6}
...
\definecolor{listing-javadoc-comment}{HTML}{000000}
...
\fancypagestyle{header-footer}{
  ...
  \rhead[$if(header-left)$$header-left$$else$$title$$endif$]{$if(header-right)$$header-right$$else$$date$\thepage$endif$}
  ...
  \rfoot[$if(footer-left)$$footer-left$$else$$for(author)$$author$$sep$, $endfor$$endif$]{$if(footer-right)$$footer-right$$else$$endif$}
